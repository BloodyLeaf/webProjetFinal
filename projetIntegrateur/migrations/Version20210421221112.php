 ...
 */
final class Version20210421221112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE no_groupe no_groupe SMALLINT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE no_groupe no_groupe SMALLINT DEFAULT NULL');
    }
}
