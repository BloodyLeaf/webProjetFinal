<?php
/****************************************
   Fichier : AuthentificateurAuthentificator.php
...
class AuthentificateurAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
